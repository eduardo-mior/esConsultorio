 ...
 * @author Mior
 */
public class DialogoBuscarServico extends javax.swing.JDialog {
     ...
     * @param action
     */
    public DialogoBuscarServico(java.awt.Frame parent, boolean modal, Consumer<Servico> action) {
        super(parent, modal);
        this.action = action;
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtServicos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), jbtnConfirmar, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
    ...
    private void jbtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnConfirmarActionPerformed
        Servico tp = servicos.get(jtServicos.getSelectedRow());
        if (action != null) {
            action.accept(tp);
        }
        this.dispose();
