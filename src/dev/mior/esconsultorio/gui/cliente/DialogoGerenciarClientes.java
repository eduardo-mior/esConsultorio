 ...
 * @author Mior
 */
public class DialogoGerenciarClientes extends javax.swing.JDialog {

    /** User variables and constants */
    private String filtroAtual = "Nome", filtroVelho;
    private String inputAtual = "", inputVelho;
    private static final EntityDAO<Cliente> DAO = new EntityDAO<>(Cliente.class);
     ...
     * @param modal
     */
    public DialogoGerenciarClientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jbtnInformacoes = new javax.swing.JToggleButton();
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtClientes, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), jbtnEditar, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        ...
        jbtnApagar.setText("Apagar Cliente");
        jbtnApagar.setFocusPainted(false);
        jbtnApagar.setFocusable(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtClientes, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), jbtnApagar, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        jbtnInformacoes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/info.png"))); // NOI18N
        jbtnInformacoes.setMnemonic('V');
        jbtnInformacoes.setText("Visualizar Cliente");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtClientes, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), jbtnInformacoes, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        jbtnInformacoes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnInformacoesActionPerformed(evt);
            }
        });
        jpConfirmar.add(jbtnInformacoes);
    ...
    private void jbtnApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnApagarActionPerformed
        if (JOptionPane.showConfirmDialog(this, "Deseja realmente apagar este cliente?", "Confirmação", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION) {
            try {
                ...
                Logger.save(e);
                JOptionPane.showMessageDialog(this, "Não foi possível apagar o cliente!", "Erro Interno", JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_jbtnApagarActionPerformed

    private void jbtnInformacoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnInformacoesActionPerformed
        new DialogoVisualizarCliente((Frame) getParent(), true, clientes.get(jtClientes.getSelectedRow())).setVisible(true);
    }//GEN-LAST:event_jbtnInformacoesActionPerformed
    ...
    private javax.swing.JToggleButton jbtnInformacoes;
