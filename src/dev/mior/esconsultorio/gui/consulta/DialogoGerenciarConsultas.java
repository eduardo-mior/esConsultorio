 ...
 * @author Mior
 */
public class DialogoGerenciarConsultas extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DialogoGerenciarConsultas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        if (jtConsultas.getColumnModel().getColumnCount() > 0) {
            ...
            jtConsultas.getColumnModel().getColumn(1).setCellRenderer(new dev.mior.esconsultorio.gui.renderer.DataRenderer());
            ...
            jtConsultas.getColumnModel().getColumn(3).setMinWidth(80);
            jtConsultas.getColumnModel().getColumn(3).setPreferredWidth(80);
            jtConsultas.getColumnModel().getColumn(3).setMaxWidth(80);
            jtConsultas.getColumnModel().getColumn(3).setCellRenderer(new dev.mior.esconsultorio.gui.renderer.HorarioRenderer());
            jtConsultas.getColumnModel().getColumn(4).setMinWidth(150);
            jtConsultas.getColumnModel().getColumn(4).setPreferredWidth(150);
            jtConsultas.getColumnModel().getColumn(4).setMaxWidth(150);
            jtConsultas.getColumnModel().getColumn(4).setCellRenderer(new dev.mior.esconsultorio.gui.renderer.DinheiroRenderer());
            jtConsultas.getColumnModel().getColumn(5).setCellRenderer(new dev.mior.esconsultorio.gui.renderer.ListaRenderer());
            jtConsultas.getColumnModel().getColumn(6).setCellRenderer(new dev.mior.esconsultorio.gui.renderer.AreaDeTextoRenderer());
        }
