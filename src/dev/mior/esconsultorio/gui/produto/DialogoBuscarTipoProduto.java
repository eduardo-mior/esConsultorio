 ...
 * @author Mior
 */
public class DialogoBuscarTipoProduto extends javax.swing.JDialog {
    ...
    /**
     * Creates new form DialogoBuscaTipoProduto
     * @param parent
     * @param modal
     * @param action
     */
    public DialogoBuscarTipoProduto(java.awt.Frame parent, boolean modal, Consumer<TipoProduto> action) {
        super(parent, modal);
        this.action = action;
        initComponents();
    ...
    private void initComponents() {
        ...
        jtfInformacao.setToolTipText("Descrição do tipo do produto");
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jtTiposProdutos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), jbtnConfirmar, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        ...
        if (jtTiposProdutos.getColumnModel().getColumnCount() > 0) {
            jtTiposProdutos.getColumnModel().getColumn(0).setMinWidth(150);
            jtTiposProdutos.getColumnModel().getColumn(0).setPreferredWidth(200);
        }
    ...
    private void jbtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnConfirmarActionPerformed
        TipoProduto tp = tiposProdutos.get(jtTiposProdutos.getSelectedRow());
        if (action != null) {
            action.accept(tp);
        }
        this.dispose();
